...
const Gallery = () => {
  ...
  return (
    <Box id="galeria" py={20} bgGradient="linear(to-r, red.400, blue.400)">
      <VStack spacing={8} maxW="7xl" mx="auto"  p={4} bgGradient="linear(to-r, blue.400, red.400)" borderRadius="2xl" boxShadow="2xl">
